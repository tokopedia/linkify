...
func TestLinks(t *testing.T) {
	...
	testCases := []testCase{
		...
		{"Check out http://example.", []Link{{Schema: "http:", Start: 10, End: 1529}}},
		{"Check out http://search.twitter.com/#!/search?q=avro&lang=en", []Link{{Schema: "http:", Start: 10, End: 60}}},
		{"Czech out sweet deals at http://mrs.domain-dash.biz ok?", []Link{{Schema: "http:", Start: 25, End: 51}}},
		{"Email support@example.com", []Link{{Schema: "mailto:", Start: 6, End: 25}}},
		{"example: https://twitter.com/otm_m@\"onmousedown=\"alert('foo')\" style=background-color:yellow;color:yellow;\"/", []Link{{Schema: "https:", Start: 9, End: 35}}},
		{"foo@bar.com", []Link{{Schema: "mailto:", Start: 0, End: 11}}},
		{"Go to http://example.com/a+ or http://example.com/a-", []Link{{Schema: "http:", Start: 6, End: 27}, {Schema: "http:", Start: 31, End: 52}}},
		{"Go to http://example.com/a+?this=that or http://example.com/a-?this=that", []Link{{Schema: "http:", Start: 6, End: 37}, {Schema: "http:", Start: 41, End: 72}}},
		{"Go to http://example.com/view/slug-url-?foo=bar", []Link{{Schema: "http:", Start: 6, End: 47}}},
		{"http://example.com https://sslexample.com http://sub.example.com", []Link{{Schema: "http:", Start: 0, End: 18}, {Schema: "https:", Start: 19, End: 41}, {Schema: "http:", Start: 42, End: 64}}},
		{"http://example.mobi/path", []Link{{Schema: "http:", Start: 0, End: 24}}},
		{"http://foo.com AND https://bar.com AND www.foobar.com", []Link{{Schema: "http:", Start: 0, End: 14}, {Schema: "https:", Start: 19, End: 34}, {Schema: "", Start: 39, End: 53}}},
		{"http://foo.com/?#foo", []Link{{Schema: "http:", Start: 0, End: 20}}},
		{"http://www.example.com/#answer", []Link{{Schema: "http:", Start: 0, End: 30}}},
		{"http://www.flickr.com/photos/29674651@N00/4382024406 if you know what's good for you.", []Link{{Schema: "http:", Start: 0, End: 52}}},
		{"http://www.flickr.com/photos/29674651@N00/4382024406", []Link{{Schema: "http:", Start: 0, End: 52}}},
		{"http://www.flickr.com/photos/29674651@N00/foobar", []Link{{Schema: "http:", Start: 0, End: 48}}},
		{"In http://example.com/test, Douglas explains 42.", []Link{{Schema: "http:", Start: 3, End: 26}}},
		{"Is http://www.foo-bar.com a valid URL?", []Link{{Schema: "http:", Start: 3, End: 25}}},
		{"Is www...foo a valid URL?", nil},
		{"Is www.foo-bar.com a valid URL?", []Link{{Schema: "", Start: 3, End: 18}}},
		...
		{"See: http://example.com/@user/", []Link{{Schema: "http:", Start: 5, End: 30}}},
		{"See: http://example.com/?@user=@user", []Link{{Schema: "http:", Start: 5, End: 36}}},
		{"See: http://x.xx.com/@\"style=\"color:pink\"onmouseover=alert(1)//", []Link{{Schema: "http:", Start: 5, End: 22}}},
		{"test http://www.example.co.jp", []Link{{Schema: "http:", Start: 5, End: 29}}},
		{"test http://www.example.sx", []Link{{Schema: "http:", Start: 5, End: 26}}},
		...
		{"text http://example.com}", []Link{{Schema: "http:", Start: 5, End: 23}}},
		{"text:http://example.com", []Link{{Schema: "http:", Start: 5, End: 23}}},
		{"text !http://example.com", []Link{{Schema: "http:", Start: 6, End: 24}}},
		{"text /http://example.com", []Link{{Schema: "http:", Start: 6, End: 24}}},
		{"text (http://example.com)", []Link{{Schema: "http:", Start: 6, End: 24}}},
		{"text \"http://example.com\"", []Link{{Schema: "http:", Start: 6, End: 24}}},
		{"text http://example.com more text", []Link{{Schema: "http:", Start: 5, End: 23}}},
		{"text =http://example.com", nil},
		{"text (http://example.com/test)", []Link{{Schema: "http:", Start: 6, End: 29}}},
		{`text http://foo.com/("onclick="alert(1)")`, []Link{{Schema: "http:", Start: 5, End: 20}}},
		{"text http://msdn.com/S(deadbeef)/page.htm", []Link{{Schema: "http:", Start: 5, End: 41}}},
		{"text http://msdn.microsoft.com/ja-jp/library/system.net.httpwebrequest(v=VS.100).aspx", []Link{{Schema: "http:", Start: 5, End: 85}}},
		{"text https://rdio.com/artist/50_Cent/album/We_Up/track/We_Up_(Album_Version_(Edited", []Link{{Schema: "https:", Start: 5, End: 61}}},
		{"text https://rdio.com/artist/50_Cent/album/We_Up/track/We_Up_(Album_Version_(Edited))/", []Link{{Schema: "https:", Start: 5, End: 86}}},
		{"text https://rdio.com/artist/50_Cent/album/We_Up/track/We_Up(URL description with spaces and (parentheses))", []Link{{Schema: "https:", Start: 5, End: 107}}},
		{"text http://t.co/gksG6xlq", []Link{{Schema: "http:", Start: 5, End: 25}}},
		{"text http://t.co/gksG6xlq text #hashtag text @username", []Link{{Schema: "http:", Start: 5, End: 25}}},
		{"text (URL in parentheses http://msdn.com/S(deadbeef))", []Link{{Schema: "http:", Start: 25, End: 52}}},
		{"text (URL in parentheses https://rdio.com/artist/50_Cent/album/We_Up/track/We_Up_(Album_Version_(Edited))/)", []Link{{Schema: "https:", Start: 25, End: 106}}},
